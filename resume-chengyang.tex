...
Research Interests: I'm broadly interested in computer networking \& system architecture, devoted to building High-performance networked systems, with special focus on distributed machine learning system
...
\datedsubsection{Mars: exploring data-driven routing with multi-agent reinforcement learning}{2019.06 -- 2019.12}
%\role{Research Intern}{Manager(s): Yongqiang Xiong and Guangshu Liu}
%Brief introduction: xxx.
\begin{itemize}
	\item Exploring the designing of data-driven routing system with multi-agent reinforcement learning;
...
\begin{enumerate}[label={[\arabic*]}, noitemsep]
	...
	\item \authorlist{Kaihui Gao, Dan Li, Li Chen, Jinkun Geng, Fei Gui, \textbf{Yang Cheng}, and Yue Gu}, \papertitle{Incorporating Intra-flow Dependencies and Inter-flow Correlations for Traffic Matrix Prediction}, \publicationaddr{IEEE/ACM International Symposium on Quality of Service (ACM/IEEE IWQoS 2020)}
